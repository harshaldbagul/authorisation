...
<div class="row">
     ...
     <div class="col-3 col-lg-2">
        <ul class="nav flex-column "   >
               ...
               <br/>            <br/>
                <div class="button_cont" align="center"><a class="example_b" href="components" style="width: 200px">Register    Component constraints   </a></div>
...
<div class="col-8 col-lg-9" style="border:solid;border-width:1px;border-color:#E2E2E2;margin-top:10px;background-color:white;">   
  <div class="row" style="margin-top:10px;">
    <div class="col-5">
        ...
        <div class="row ">
            <div class="col-1 align-items-center" style="background-color:#4D4D4D;color: white;line-height: 33px;">4</div>
            <div class="w-100"></div>
            <div class="col-1"></div>
  ...
  <div class="form-style-2">
    <div class="form-style-2-heading">Register the component constraints of the application</div>
    <form method="post">
    ...
    <label for="field2"><span>Component List <span class="required">*</span></span><input type="text" class="input-field" name="componentId" value="" required/></label>

    <label><span> </span><input type="submit" value="Register Components" /></label>
    </form>
    
    <div style="margin-left:20%;">
		<input type="submit" value="Show Registered Components" id="showApi" />
	</div>
			<div>
				<div id="apis"  >
...
$(document).ready(function(){
    $("#showApi").click(function(){
        $.getJSON("http://10.11.188.158:8080/authorisation/getComponentsList", function(result){
        console.log(result,'this is result');
        var tableBody = '<div style="margin-left:20%; width:100%; margin-top:5%;"><table border="1" id="showtable"  class="table table-hover"><thead style="background-color: #38a108; color: white;"><tr><th>AppName</th><th>Api Url</th><th>ComponentId</th><th>Role</th></tr></thead><tbody></div>';
